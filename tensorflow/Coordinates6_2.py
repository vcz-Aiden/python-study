...
class PredCameraModel(tf.keras.Model):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        result_x = tf.math.divide_no_nan(result_x, total)
        result_y = tf.math.divide_no_nan(result_y, total)
...
if __name__ == '__main__':
    ...
    model.fit(train_ds, validation_data=test_ds, epochs=EPOCHS, callbacks=[earlystopper])
